...
public class AntColony  {
    ...
    public AntColony(int numAnts, int numIterations, double alpha, double beta, double evaporationRate,
    ...
    public static void main(String[] args) {
        ...
        AntColony antColonyy = new AntColony(numAnts, numIterations, alpha, beta, evaporationRate, distances,
                startCity);
